...
def get_pie_chart(entered_site):
    ...
    # = spacex_df.groupby(['Launch Site'])['class'].count().reset_index(name='class count')
    if entered_site == 'ALL':
        ...
        title=f'Success and Failure rates for Launch Site {entered_site}' )
        return fig
# TASK 4:
...
def get_scatter(entered_site, entered_payload):
    ...
    if entered_site == 'ALL':
        ...
        title=f'Success and Failure rates for Launch Site {entered_site}', color="Booster Version Category")
        return fig
